...
cytokine_merge<-read.table("cytokine_merge.txt",header = TRUE,row.names = 1,sep = "\t")
ggplot(cytokine_merge,aes(x=cytokine_merge$CT,y=cytokine_merge$sCD40L,fill=cytokine_merge$CT))+ #”fill=“设置填充颜色
    ...
    geom_jitter(aes(fill=cytokine_merge$CT),width =0.2,shape = 21,size=2.5)+ #设置为向水平方向抖动的散点图，width指定了向水平方向抖动，不改变纵轴的值
